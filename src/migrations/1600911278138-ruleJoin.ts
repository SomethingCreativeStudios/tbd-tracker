...
export class ruleJoin1600911278138 implements MigrationInterface {
    name = 'ruleJoin1600911278138'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sub_group" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_c447034fd51994aeac7ed6d8b88" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "sub_group_rule" ("id" SERIAL NOT NULL, "text" character varying NOT NULL, "ruleType" character varying NOT NULL, "ruleJoin" boolean NOT NULL, "subGroupId" integer, CONSTRAINT "PK_5ee2022e048830e9e36624b9028" PRIMARY KEY ("id"))`);
