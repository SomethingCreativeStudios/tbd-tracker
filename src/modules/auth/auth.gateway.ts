...
import { CACHE_MANAGER, Inject, Logger, UnauthorizedException } from '@nestjs/common';
...
export class AuthGateway implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect {
  constructor(private userService: UserService, private authService: AuthService, private roleService: RoleService, private socketService: SocketService, @Inject(CACHE_MANAGER)
